...
class TestApplicationWorkflow:
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workflow_application_await.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workflow_registration_await.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workflow_registration_cc.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workflow_registration_pass.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workflow_registration_refuse.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workforce_application_workflow_default.yaml'))
    ...
    @pytest.mark.parametrize('data',
                             YamlHandle().read_yaml(
                                 'SingleInterfaceData/Workforce/WorkforceWorkflow/workforce_registration_workflow_default.yaml'))
